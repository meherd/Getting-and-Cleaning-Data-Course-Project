## This is a README Markdown for Getting and Cleaning Data Course Project 
...
### The run_analysis.R file contains the code to,
* Download the data
* Read 'Train' and 'Test' data sets into data table
* Merge Train and Test data tables 
* Set lables and descriptive names 
* Create tidydata 

### The CodeBook.md has more detail for each step of the code.